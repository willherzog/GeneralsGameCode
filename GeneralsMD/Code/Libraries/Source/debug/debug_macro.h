...
/**
  ...
  All these macros are defined if either RTS_DEBUG or _INTERNAL is defined. Otherwise
...
///@{
  ...
  /**
    ...
    Assertions are completely removed if neither RTS_DEBUG nor _INTERNAL are defined.
...
#elif defined(RTS_DEBUG) || defined(_INTERNAL)
